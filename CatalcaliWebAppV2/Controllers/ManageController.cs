    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "Telefon numaranız kaydedildi."
                : message == ManageMessageId.RemovePhoneSuccess ? "Telefon numaranız silindi."
                : message == ManageMessageId.ChangeUserInformationSuccess ? "Kullanıcı bilgileriniz başarıyla güncellendi."
                : message == ManageMessageId.ChangeAddressSuccess ? "Adres bilginiz başarıyla güncellendi."
                : "";
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                TempData["message.success"] = "Yeni Şifreniz Kayıt Edildi";
                return RedirectToAction("Index", new { Message = ManageMessageId.ChangePasswordSuccess });
            }
            TempData["message.error"] = "Yeni Şifreniz Kayıt Edilirken Bir Hatayla Karşılaşıldı. Lütfen Tekrar Deneyiniz.";
            AddErrors(result);
            return View(model);
        }
        // GET: /Manage/ChangeUserInformation
        [Route("kullanici-bilgi-güncelleme")]
